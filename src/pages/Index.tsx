...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {activeTab === "home" && (
        <div className="max-w-7xl mx-auto py-2 px-2 pb-20">
          <div className="space-y-2">
            {/* Floral Calendar Header */}
            <div className="relative bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl overflow-hidden">
              ...
              <div className="relative px-3 py-3">
                <div className="text-center">
                  {(() => {
                    ...
                    return (
                      <>
                        <p className="text-[10px] text-gray-500 uppercase tracking-wider">Next Period</p>
            ...
            {visibility.periodCalendar && (
              <div className="space-y-2">
                <h3 className="text-xs font-semibold text-foreground px-1">Your Calendar</h3>
                <PeriodCalendar 
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  {visibility.pcosMode && (
                    <button
                      ...
                      className="flex items-center gap-2 p-3 bg-gradient-to-br from-teal-50 to-emerald-50 rounded-xl border border-teal-100 hover:shadow-md transition-all"
                    >
                      <div className="w-9 h-9 rounded-full bg-teal-500 flex items-center justify-center flex-shrink-0">
                        <Brain className="w-4 h-4 text-white" />
                      </div>
                      <div className="text-left min-w-0">
                        <p className="text-xs font-semibold text-gray-900 whitespace-nowrap">PCOS Mode</p>
                        <p className="text-[9px] text-gray-500">Track symptoms</p>
                      </div>
                    </button>
                  )}
                  ...
                  {visibility.perimenopauseMode && (
                    <button
                      ...
                      className="flex items-center gap-2 p-3 bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl border border-amber-100 hover:shadow-md transition-all"
                    >
                      <div className="w-9 h-9 rounded-full bg-amber-500 flex items-center justify-center flex-shrink-0">
                        <Flower2 className="w-4 h-4 text-white" />
                      </div>
                      <div className="text-left min-w-0">
                        <p className="text-xs font-semibold text-gray-900 whitespace-nowrap">Perimenopause</p>
                        <p className="text-[9px] text-gray-500">Track changes</p>
                      </div>
                    </button>
                  )}
                </div>

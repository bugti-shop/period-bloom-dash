        ...
        {visibleFeatures.map((feature) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 p-4 ${feature.bgColor} ${feature.borderColor} border rounded-lg`}
            >
              <div className={`w-11 h-11 ${feature.color} rounded-lg flex items-center justify-center`}>

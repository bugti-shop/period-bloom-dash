    ...
    <div className="bg-card rounded-2xl p-4 shadow-sm border border-border/50">
      ...
      <div className="flex items-center justify-between mb-4">
        <button
          ...
          className="w-8 h-8 rounded-xl bg-muted/50 hover:bg-muted flex items-center justify-center transition-all"
          ...
          return (
            <button
              ...
              className={`
                ...
                ${onDateSelect ? "hover:scale-110 cursor-pointer active:scale-95" : ""}
              `}
            >
              {format(day, "d")}
            </button>

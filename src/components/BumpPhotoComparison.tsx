      ...
      <Card className="w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-semibold text-foreground">Compare Bump Photos</h2>
          ...
          {availableWeeks.length < 2 ? (
            <div className="text-center py-12 text-muted-foreground">
              <p>You need at least 2 photos to compare.</p>
              <p className="text-sm mt-2">Add more weekly photos to use this feature.</p>
            </div>
          ) : (
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {week1 !== null && weekPhotos[week1] && (
                  <div>
                    <h3 className="text-lg font-semibold mb-3 text-foreground">Week {week1}</h3>
                    <img
                ...
                {week2 !== null && weekPhotos[week2] && (
                  <div>
                    <h3 className="text-lg font-semibold mb-3 text-foreground">Week {week2}</h3>
                    <img
